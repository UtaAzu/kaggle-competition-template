...
into experiments/<EXP_ID>/<exp_id>-artifacts/metadata_from_kaggle.json and experiments/<EXP_ID>/run.json.

Usage:
    python3 scripts/record_artifacts_kaggle.py EXP_ID --slug owner/dataset-name \
            --kaggle-artifacts-path /kaggle/input/<dataset-slug>/artifacts
...
def main(argv: List[str] = None):
    ...
    if (base / "artifacts" / exp_id).exists():
        ...
        # if user passed full path like /kaggle/input/<dataset-slug>-dataset/artifacts
